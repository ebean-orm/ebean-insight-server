...
@Command(name = "config", mixinStandardHelpOptions = true,
    ...
    footer = {
        "  # URL + OAuth2 — easiest via setup command:",
        "  insight setup https://ebean-insight.example.com",
        "",
        "  # Or set manually (Cognito):",
        "  insight config set url https://ebean-insight.example.com",
        ...
        "",
        "  # Or set manually (Microsoft Entra ID):",
        "  insight config set auth-client-id <entra-app-client-id>",
        "  insight config set auth-tenant-id <entra-tenant-id>",
        "  insight config set auth-scope api://<entra-app-client-id>/access_as_user",
        "  insight login                    # authenticate once (opens browser; no --device support)",
        "",
        ...
        "  insight setup https://test.example.com --profile test",
        ...
        "  auth-domain, auth-user-pool-id, auth-tenant-id, auth-client-id, auth-scope, auth-redirect-port",
    },
    subcommands = {
